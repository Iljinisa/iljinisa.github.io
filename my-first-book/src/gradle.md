...
Tehdään nyt gradle-projekti alusta asti itse. Tee [palautusrepositorioosi](tehtavat1.md#teht%C3%A4vien-palautusrepositoriot) uusi hakemisto ja mene hakemistoon. 
...
Yleensä Java-koodia ei suoriteta käyttämällä suoraan _class_-tiedostoja. Parempi tapa on pakata koodi  _jar_-tiedostoksi viikon 1 [tehtävän 7](tehtavat1.md#7-gradle) tapaan.
